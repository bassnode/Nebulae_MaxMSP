...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 410.0, 36.0, 35.0, 18.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					"autorestore" : "Nebulae-MersenneFM-presets.json",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-27",
					"maxclass" : "newobj",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 53.0, 241.0, 20.0 ],
					"saved_object_attributes" : 					{
...
,
					"text" : "pattrstorage Nebulae-MersenneFM-presets",
					"varname" : "Nebulae-MersenneFM-presets"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 508.704895, 772.461121, 165.0, 105.0 ],
					"presentation" : 1,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.5, 685.5, 77.0, 32.0 ],
									"text" : "© 2014"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.5, 145.5, 653.0, 110.0 ],
									"text" : "MersenneFM\t\nFM instrument with 3 rhythmic oscillator triggers. \n\tThe tables for this instrument were created using the Mersenne and Recaman number \tsequences. ",
									"textjustification" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 14.5, 255.5, 653.0, 409.0 ],
									"text" : "~ Parameters ~\n\nFrequency -- a common denominator, in cycles per second, for the carrier and modulating frequencies.\n\nCarrier -- a factor that, when multiplied by the kcps parameter, gives the carrier frequency.\n\nModulator -- a factor that, when multiplied by the kcps parameter, gives the modulating frequency.\n\nIndex -- the modulation index.\n\nOscillator Frequency -- the overall rhythmic speed\n\nMetro1 -- oscillator trigger; increased metronome speed will create rhythmic variations.\n\nMetro2 -- oscillator trigger; increased metronome speed will create rhythmic variations.\n\nMetro3 -- oscillator trigger; increased metronome speed will create rhythmic variations.",
									"textjustification" : 1
								}
...
,
					"patching_rect" : [ 27.013142, 816.907898, 114.0, 17.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.114014, 580.607117, 127.0, 20.0 ],
					"text" : "prepend set Osc Freq"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.114014, 317.607178, 134.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.295715, 580.607117, 115.0, 20.0 ],
					"text" : "prepend set Metro1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 497.295715, 317.607178, 114.0, 20.0 ],
					"text" : "prepend set Carrier"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.477478, 580.607117, 115.0, 20.0 ],
					"text" : "prepend set Metro2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 704.477478, 317.607178, 131.0, 20.0 ],
					"text" : "prepend set Modulator"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 904.4776, 580.607117, 115.0, 20.0 ],
					"text" : "prepend set Metro3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 280.113953, 60.647575, 193.545456, 44.704849 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 16.347109, 173.126526, 296.0, 24.0 ],
					"saved_object_attributes" : 					{
						"args" : "Nebulae-c74-MersenneFM.csd",
						"autostart" : 0,
						"bypass" : 0,
						"input" : 1,
						"interval" : 10,
...
,
					"text" : "csound~ Nebulae-c74-MersenneFM.csd"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 81.247108, 204.563263, 45.013138, 204.563263 ],
					"source" : [ "obj-338", 1 ]
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "qubit.png",
				"bootpath" : "/Volumes/subbase/-Respository-/Nebulae_MaxMSP/MersenneFM",
				"patcherrelativepath" : ".",
				"type" : "PNG ",
				"implicit" : 1
			}
...
, 			{
				"name" : "Nebulae-MersenneFM-presets.json",
				"bootpath" : "/Volumes/subbase/-Respository-/Nebulae_MaxMSP/MersenneFM",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
